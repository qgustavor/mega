...
import { e64, getCipher, prepareKey, formatKey, AES } from './crypto'
...
class Storage extends EventEmitter {
  constructor (options, cb) {
    ...
    if (options.email) {
      ...
      const pw = prepareKey(new Buffer(options.password))
      let aes = new AES(pw)
      const uh = e64(aes.stringhash(new Buffer(options.email)))
